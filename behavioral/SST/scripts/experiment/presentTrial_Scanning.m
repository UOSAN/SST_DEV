function [Pos Seeker FLAG_FASTER] = presentTrial_Scanning(Pos,Seeker,FLAG_FASTER,colorFlags,MRI,block,a,b,postjitter,imagetex,w,standardImHeight,standardImArea,oval2imRatio,ArrowSize,ArrowPosX,ArrowPosY,arrow_duration,anchor,inputDevice,pahandle,wave,fid)
