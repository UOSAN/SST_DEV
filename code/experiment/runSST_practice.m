...
save([DIR.output 'stimPrezOrder_DEV' placeholder num2str(subject_code) '.mat'],'stim','UvH','uStim','hStim','exploreStimOrder')
...
%     stimWithinRating = ImgRatings_sorted(rIdx,3);
...
% else
%     error('Not enough unhealthy stim!')
% end
